#!/usr/bin/env bash
# Host entrypoint: build ros-noetic-open-vins-estimator-plugin_*.deb for pairs_open_vins_estimator_plugin.
...
IMAGE="pairs-open-vins-estimator-plugin-noetic-packaging"
